...
When I enter rulename as "newrule" 
  ...
  And I enter "22073 in the respective text fields"
  ...
  Then I should see "Rule Detail page"
   ...
   And I should see Product Id as "22073" in the product id text field
...
When I enter "Dresses as product type"
  And I click the "Find" button
...
Then I should see "Rule Detail page"
     ...
     And I should see the "show facet product type" as "Dresses"
...
When I enter rulename as "newrule" 
  ...
  And I enter "valid Product Id as 22073 in Product id text field on the Create Rule page"
  And I enter "valid Saved Set/Query ID as 10 in Saved Set Query ID text field on the Create Rule page"
  And I click the "save action" button
  And I click "Browse" check box
  And I click the "Save rule" button
Then I should see "Rule Detail page"
    ...
    And I should see the "mrs action Product id" as "22073"
    And I should see the "saved set query id" as "10"
...
When I select the "category facet and facet values and verify"  
 ...
 | Special Offers  | Free Shipping,Gift with Purchase,Sales & Offers,Special Purchase                                        |
 | Department      | Beauty,Handbags,Home,Jewelry & Accessories,Kids,Women,Plus Sizes,Shoes,Petites,Men                      |
 | Dress Style     | Black & White,Bodycon,Embellished,Leather,Jumpsuits & Rompers,Sweater,Maxi                              |
 | Color Family    | Purple,Red,Silver,White,Yellow,Tan/Beige,Black,Blue,Brown,Ivory/Cream,Gold,Green,Gray,Multi,Orange,Pink |
 And I click the "Ok facets" button 
Then I should "see summary panel with facet_name & facet_values" 
 | facet_name      | facet_value                                                                                             |
 | Special Offers  | Free Shipping,Gift with Purchase,Sales & Offers,Special Purchase                                        |
 | Department      | Beauty,Handbags,Home,Jewelry & Accessories,Kids,Women,Plus Sizes,Shoes,Petites,Men                      |
 | Dress Style     | Black & White,Bodycon,Embellished,Leather,Jumpsuits & Rompers,Sweater,Maxi                              |
...
When I select "Product Data Match" from the trigger pulldown
     And I select "<attribute type>" from product data match dropdown and enter "<attribute value>"
           | Search_Type     | Buffet/Console      |
           | Search_Occasion | Evening/Formal      |
...
When I click the "Add Rule" button
  ...
  And I select "1891 by Sferra" from Select Value(s) scroll list
