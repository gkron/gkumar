...
@regression_mcom_pom
@jregression_17977_1_4.2_mcom
Scenario: As a user I should see Default RDPP Site Rules for MCOM Site
Given I have logged into Saturn as a Merchandise user
When I search for "rulename" as "Default_Site_RDPP_Rule" from "global search" 
 And I click "ruleid" from rulelisting page
Then I should see "one rddp action row inserted in rdpp_assignment table" with "MERCH_RULE_NAME,SITE_TENANT,PUBLISH_FLAG" with respective values "Default_Site_RDPP_Rule,MCOM,Y"
 And I should see "rulename" as "Default_Site_RDPP_Rule" in "rules detail page"
 And I should see "description" as "Default RDPP rule for Site" in "rules detail page"
 ...
 And I should see "rulename" as "Default_Site_RDPP_Rule" in "rules detail page"
 And I should see "default checked inventory assortment type" as "Site" in "rules detail page"
 And I should see "following inventory assortment types unchecked" from "rules detail page"
                   |Registry|
                   |Store|
                   |Shoes|
                   |Jewelry|
 ...
 And I should see "selected navigation type" as "Browse" in "rules detail page"
 And I should see "includes" as "context atrributes value" in "trigger detail page"
...
@regression_mcom_pom
@jregression_17977_2_4.2_mcom
Scenario: As a user I should see Default_Registry_RDPP_Rule for MCOM Site
Given I have logged into Saturn as a Merchandise user
When I search for "rulename" as "Default_Registry_RDPP_Rule" from "global search" 
 And I click "ruleid" from rulelisting page
Then I should see "one rddp action row inserted in rdpp_assignment table" with "MERCH_RULE_NAME,SITE_TENANT,PUBLISH_FLAG" with respective values "Default_Registry_RDPP_Rule,MCOM,Y"
 And I should see "rulename" as "Default_Registry_RDPP_Rule" in "rules detail page"
 And I should see "description" as "Default RDPP rule for Registry" in "rules detail page"
 And I should see "Rule Detail Edit button" as "enabled" in "rules detail page"
 And I should see "Rule Detail Copy button" as "enabled" in "rules detail page"
 And I should see Publish Flag "ON"
 And I should see "Rule Effective State" as "Effective" in "rules detail page"
 And I should see "default checked inventory assortment type" as "Registry" in "rules detail page"
 And I should see "following inventory assortment types unchecked" from "rules detail page"
                   |Site|
                   |Store|
                   |Shoes|
...
@regression_mcom_pom
@jregression_18098_4.3_mcom
Scenario: Verify Multiple RDPP Algorithm functionality in Saturn 
Given I have logged into Saturn as a Merchandise user
When I click "Create Rule" from "RULES"
When I enter "rulename" as "rdppaction" in "saturn main page"
...
When I select "80 - Clearance/OH Dollar" from "rdpp algorithm type drop down" in "create rule page"
 ...
 And I select "52 - Sitewide Default" from "rdpp algorithm type drop down" in "create rule page"
...
Then I should see "rulename" as "rdppaction" in "rules detailed page"
 ...
 And I should see "Rule Effective State" as "Effective" in "rules detail page"
 And I should see "selected action type" as "RDPP Algorithm" in "rules detail page"
 And I should see "rdpp algorithm type" as "80 - Clearance/OH Dollar" in "rules detailed page"
 ...
 And I should see "multiple rddps displayed" in "rules detail page"
 And I should see "rdpp algorithm type" as "52 - Sitewide Default" in "rules detail page"
 And I should see "effective date & expiration date's" as "next days of previous rdpp dates" in "rules detail page"

@regression_mcom_pom
@jregression_mcom_16300_18463_4.4_mcom
...
@regression_mcom_pom
@jregression_mcom_16300_18463_4.4_mcom12
...
@regression_mcom_pom
@jregression_18438_4.6_mcom
Scenario: In Stella MCOM I am able to add or remove "Desktop Site, Desktop Registry, Mobile, Tablet" in Display Name drop down  
...
Then I should see "following atrributes" from "product data match trigger dropdown"
                  ...
                  |Product Type|
                  |Brand|
When I create "product data macth trigger" with "Search_Type" and the value as "V-Neck,aftershave"
When I click "plusicon" in "create rule page"
When I create "product data macth trigger" with "Search_Occasion" and the value as "Wedding/Anniversary,Evening/Formal"
When I click "plusicon" in "create rule page"
...
When I click "plusicon" in "create rule page"
When I create "product data macth trigger" with "Search_Style" and the value as "Relaxed,J-Pocket"
When I click "plusicon" in "create rule page"
When I create "product data macth trigger" with "Product Noun" and the value as "food storage,garment-bags"
...
When I click "plusicon" in "create rule page"
When I create "product data macth trigger" with "Product Type" and the value as "Camera,Personal Care"
When I select "<following resultset attributes>" from "product data match trigger dropdown" than I see "not allowed duplicate attributes" and "not saveed triggers with invalid data"
                  |Search_Type|
                  |Search_Occasion|
                  |Search_Material|
...
When I replace "Wedding/Anniversary" with "New Year's Eve" from "pdm trigger" in "trigger group detail page"
When I save the "product data match trigger" with "all attributes types"
When I save the "trigger group details page" with "triggers"
Then I should see "trigger group name" as "Copy of rulestesting" in "trigger group detail page"
Then I should see "product data match triggers displayed" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Type,V-Neck,aftershave" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Occasion,New Year's Eve,Evening/Formal" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Material,Leather,Wood" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Gender,Female,Child" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Style,Relaxed,J-Pocket" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Product Noun,food storage,garment-bags" in "trigger group detail page"
Then I should see "pdm attrubute type and attribute value" as "Product Type,Camera,Personal Care" in "trigger group detail page"
...
Then I should see "keyword pattern attrubute type and attribute value" as "Material,leather,wood" in "trigger group detail page"
...
When I create "facet refinement trigger" with "Brand" and the value as "100% Pure,1888 Mills"
When I click "plusicon" in "create rule page"
When I create "facet refinement trigger" with "Product Color" and the value as "gold,green"
When I click "plusicon" in "create rule page"
When I create "facet refinement trigger" with "Occasion" and the value as "evening,formal"
...
Then I should see "facet type and facet value" as "Brand,100% Pure,1888 Mills" in "trigger group detail page"
Then I should see "facet type and facet value" as "Product Color,Gold,Green" in "trigger group detail page"
Then I should see "facet type and facet value" as "Occasion,Evening,Formal" in "trigger group detail page"
When I click "Copy button" in "rules detail page"
...
When I click "trigger Group Edit" in "trigger Group detailed page"
When I click "Edit trigger" in "rules detailed page"
When I replace "1888 Mills" with "Cache" from "facet refinement trigger" in "trigger group detail page"
When I click "plusicon" in "create rule page"
When I create "facet refinement trigger" with "Material" and the value as "Leather,wood"
When I save the "facet refinement trigger" with "all attributes types"
When I save the "trigger group details page" with "triggers"
When I click "Cancel" in "Trigger Group Alert popup"
When I save the "trigger group details page" with "triggers"
...
Then I should see "trigger group description" as "resultsettesting" in "trigger group detail page"
Then I should see "facets displayed" in "trigger group detail page"
Then I should see "facet type and facet value" as "Brand,100% Pure,Cache" in "trigger group detail page"
Then I should see "facet type and facet value" as "Product Color,Gold,Red" in "trigger group detail page"
Then I should see "facet type and facet value" as "Occasion,Evening,Formal" in "trigger group detail page"
Then I should see "facet type and facet value" as "Material,Leather,Wood" in "trigger group detail page"

@regression_mcom_pom
@jregression_18639_19149_4.7_mcom_rerun
...
When I select "Facet Refinement" from "select trigger dropdown" in "create rule page"
Then I should see "refine by following facets displayed" in "create group trigger page"
When I create "facet refinement trigger" with "Brand" and the value as "100% Pure"
When I save the "facet refinement trigger" with "all attributes types"
...
Then I should see "following atrributes" from "resultset trigger dropdown"
                  ...
                  |Price Type|
                  |Promo ID|
When I create "result set trigger" with "Category" and the value as "51145,>,70"
When I click "plusicon" in "create rule page"
...
When I save the "create trigger group page" with "triggers"
When I click "Copy button" in "rules detail page"
When I replace "51145" with "51146" from "result set trigger" in "trigger group detail page"
When I save the "Result set trigger" with "all attributes types"
When I save the "trigger group details page" with "triggers"
When I click "trigger Group Edit" in "trigger Group detailed page"
When I click "Edit trigger" in "rules detailed page"
...
Then I should see "51146,>,70" as "Category attribute values" in "rules detailed page"
...
When I enter "team" as "facet value" and select "value randomly from autosuggestion dropdown"
When I enter "moder" as "facet value" and select "value randomly from autosuggestion dropdown"
...
When I enter "wed" as "Search_Occasion" and select "value randomly from pdm autosuggestion dropdown"
When I click "plus symbol" in "pdm create trigger group"
When I enter "leat" as "Search_Material" and select "value randomly from pdm autosuggestion dropdown"
When I click "plus symbol" in "pdm create trigger group"
When I enter "J-Pock" as "Search_Style" and select "value randomly from pdm autosuggestion dropdown"
When I click "plus symbol" in "pdm create trigger group"
...
@regression_mcom_pom
@jregression_create_rule_page_3_mcom
...
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "triggertype" as "Result Set" in "rules detailed page"
Then I should see "51145,>,70" as "Category attribute values" in "rules detailed page"
Then I should see "Joop!,<,75" as "Brand attribute values" in "rules detailed page"
Then I should see "food storage,>,75" as "Product Noun attribute values" in "rules detailed page"
Then I should see "Blue,<,75" as "Normal Color attribute values" in "rules detailed page"
When I click "Edit Rule" in "rules detailed page"
...
When I click "Copy button" in "rules detail page"
When I click "Edit trigger" in "rules detailed page"
When I replace "51145" with "51146" from "keyword trigger" in "trigger group detail page"
When I save the "Result set trigger" with "attributes"
When I save the "rules details page" with "resultset attributes"
Then I should see "rulename" as "Copy of rulestesting" in "rules detailed page"
Then I should see "51146,>,70" as "Category attribute values" in "rules detailed page"
...
@regression_mcom_pom
@jregression_create_rule_page_4
...
Then I should see "pdm attrubute type and attribute value" as "Search_Type,V-Neck,aftershave" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Occasion,Wedding/Anniversary,Evening/Formal" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Material,Leather,Wood" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Gender,Adult,Child" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Style,Relaxed,J-Pocket" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Product Noun,food storage,garment-bags" in "trigger detail page"
When I click "Edit Rule" in "rules detailed page"
When I click "Edit trigger" in "rules detailed page"
When I replace "aftershave" with "air-purifiers" from "pdm trigger" in "trigger group detail page"
When I click "plusicon" in "create rule page"
When I create "product data macth trigger" with "Product Type" and the value as "Camera,Personal Care"
When I select "<following resultset attributes>" from "product data match trigger dropdown" than I see "not allowed duplicate attributes" and "not saveed triggers with invalid data"
                  |Search_Type|
...
When I click "Copy button" in "rules detail page"
When I click "Edit trigger" in "rules detailed page"
When I replace "Camera" with "Perfume" from "keyword trigger" in "trigger group detail page"
When I save the "product data match trigger" with "all attributes types"
When I save the "rules details page" with "resultset attributes"
Then I should see "rulename" as "Copy of rulestesting" in "rules detailed page"
Then I should see "product data match triggers displayed" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Type,V-Neck,air-purifiers" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Occasion,Wedding/Anniversary,Evening/Formal" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Material,Leather,Wood" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Gender,Adult,Child" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Search_Style,Relaxed,J-Pocket" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Product Noun,food storage,garment-bags" in "trigger detail page"
Then I should see "pdm attrubute type and attribute value" as "Product Type,Perfume,Personal Care" in "trigger detail page"
...
Given I have logged into Saturn as a Merchandise user
When I click "Create Rule" from "RULES"
When I enter "rulename" as "rulestesting" in "create rule page"
When I enter "description" as "resultsettesting" in "create rule page"
When I enter "effectivedate" as "today" in "create rule page"
When I enter "expirationdate" as "tomorrow date" in "create rule page"
When I click "add trigger" in "create rule page"
When I select "Keyword Pattern" from "select trigger dropdown" in "create rule page"
Then I should see "following atrributes" from "keyword pattern trigger dropdown"
                  |Brand|
...
Then I should see "keyword pattern attrubute type and attribute value" as "Material,leather,wood" in "trigger detail page"
...
When I click "Edit Rule" in "rules detailed page"
When I click "Edit trigger" in "rules detailed page"
When I replace "food processor" with "Framed Art" from "pdm trigger" in "trigger group detail page"
When I click "plusicon" in "create rule page"
When I create "keyword pattern trigger dropdown" with "Gender" and the value as "Female,Adult"
When I select "<following resultset attributes>" from "keyword pattern trigger dropdown" than I see "not allowed duplicate attributes" and "not saveed triggers with invalid data"
                  |Brand|
...
Then I should see "keyword pattern attrubute type and attribute value" as "Material,leather,wood" in "trigger detail page"
Then I should see "keyword pattern attrubute type and attribute value" as "Occasion,back to school/fall,evening" in "trigger detail page"
Then I should see "keyword pattern attrubute type and attribute value" as "Product Noun,framed art,makeup-brushes" in "trigger detail page"
Then I should see "keyword pattern attrubute type and attribute value" as "Style,wall clock,t shirt" in "trigger detail page"
...
@regression_mcom_pom
@jregression_create_rule_page_7_mcom_rerun
...
@regression_mcom_pom
@jregression_create_rule_page_8
...
Then I should see "facet type and facet value" as "Brand,100% Pure,1888 Mills" in "trigger detail page"
Then I should see "facet type and facet value" as "Product Color,Gold,Green" in "trigger detail page"
Then I should see "facet type and facet value" as "Occasion,Evening,Formal" in "trigger detail page"
When I click "Edit Rule" in "rules detailed page"
When I click "Edit trigger" in "rules detailed page"
When I click "plusicon" in "create rule page"
When I create "facet refinement trigger" with "Material" and the value as "Leather,wood"
...
Then I should see "facet type and facet value" as "Product Color,Gold,Green" in "trigger detail page"
Then I should see "facet type and facet value" as "Occasion,Evening,Formal" in "trigger detail page"
Then I should see "facet type and facet value" as "Material,Leather,Wood" in "trigger detail page"

@regression_mcom_pom
@jregression_create_rule_page_9123
...
@regression_mcom_pom      
@jregression_create_rule_page_1012345
Scenario: Create rule page trigger Error Validation
Given I have logged into Saturn as a Merchandise user
Then I should see "following links" from "Rules navigation bar"
                   |Find Rules|
				   |Create Rule|
...
@regression_mcom_pom     
@jregression_create_rule_page_11_mcom
...
When I select "Facet Refinement" from "trigger drop down" in "create rule page"
 And I enter "facet name and facet value" as "Brand,100% Pure" in "trigger Group detailed page"
 And I save the "triggers" with "facets"
...
@regression_mcom_pom    
@jregression_18998_4.7_mcom_90909
...
When I click "Ok" in "popup window"          
When I enter "category ids" as "11706" in "create rule page"
...
Then I should see "effectivedate" as "today" in "rules detailed page"
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "category ids" as "11706" in "rules detailed page"
When I click "Edit Rule" in "rules detailed page"
When I click "edit" in "rule detail page"
When I enter "category ids" as "11699" in "create rule page"
When I click "cancel" in "rule detail page"
When I click "edit" in "rule detail page"
When I enter "category ids" as "11697" in "create rule page"
When I save the "category ids trigger" with "valid ids"
When I save the "rules details page" with "resultset attributes"
Then I should see "category ids" as "11697" in "rules detailed page"
...
Then I should see "category ids enabled" in "create rule page"
When I select "Category Ids" from select trigger dropdown in "create rule page"
When I enter "category ids" as "199" in "create rule page"
When I save the "category ids trigger" with "valid ids"
When I click "add action" in "create rule page"
Then I should see "select action drop down displayed" in "create rule page"
...
When I create "Keyword trigger" with "keywords" and the value as "jeans,tops"
When I click "cancel" in "create rule page"
Then I should see "category ids" as "199" in "create rule page"
When I click "edit" in "create rule page"
When I select "Keyword" from "select trigger dropdown" in "create rule page"
Then I should see "keyword trigger section displayed" in "create trigger group page"
When I create "Keyword trigger" with "keywords" and the value as "jeans,tops"
...
When I click "edit action" in "rules detail page"
 ...
 And I select "Age,Color Family,Blanket" from "show facets drop down" in "create rule page" 
...
@regression_mcom_pom_as_replaced_by_21943_4.11
@jregression_18642_4.7_mcom
Scenario: All the existing Category Hierarchy Modify result set trigger(replaced by 'Category Ids' trigger)  
Given I have logged into Saturn as a Merchandise user
When I click "Find Rules" from "RULES"
...
Then I should see "category ids enabled" in "create rule page"
When I select "Category Ids" from select trigger dropdown in "create rule page"
When I enter "category ids" as "11694" in "create rule page"
When I save the "category ids trigger" with "valid ids"
When I click "add action" in "create rule page"
Then I should see "select action drop down displayed" in "create rule page"
...
When I enter "product id" as "4199" in "create rule page"
 And I enter "saved set query id" as "1873430" in "create rule page"
 And I save the "action" with "action atrributes"
When I click "Browse" in "navigation type context attributes"
When I click "Search" in "navigation type context attributes"
When I save the "creating rule page" with "resultset attributes"
...
Then I should see "effectivedate" as "today" in "rules detailed page"
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "category ids" as "11694" in "rules detailed page"
Then I should see "product id" as "4199" in "rules detailed page"
When I click "Edit Rule" in "rules detailed page"
When I click "edit action" in "rule detail page"
When I enter "product id" as "80623" in "create rule page"
 And I save the "action" with "action atrributes"
...
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "category ids" as "11694" in "rules detailed page"
Then I should see "product id" as "80623" in "rules detailed page"
Then I should see "saved set query id" as "1873430" in "rules detailed page" 

@regression_mcom_pom
@jregression_19301_4.8_mcom
...
Then I should see "product id" as "4199" in "rules detailed page"
Then I should see "saved set query id" as "1873430" in "rules detailed page" 
Then I should see "category ids" as "199" in "rules detailed page"
When I click "Copy button" in "rules detail page"
...
When I select "Show Facets" from "action drop down" in "create rule page"
 ...
 And I select "Age,Color Family" from "show facets drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "Search" in "navigation type context attributes"
...
When I click "Edit Rule" in "rules detailed page"
When I click "edit action" in "rule detail page"
 And I select "Collection,Department" from "show facets drop down" in "create rule page"
 And I enter "text1" as "display name" for the facet "Collection"
...
Then I should see Publish Flag "ON"
 ...
 And I should see "Age" as "default show facet display name" for the facet "Age" in "rules detailed page"
 And I should see "Color" as "default show facet display name" for the facet "Color Family" in "rules detailed page"  
 And I should see "text1" as "default show facet display name" for the facet "Collection" in "rules detailed page"
...
When I click "addAttributeValue" in "create rule page"
 ...
 And I click "addAttributeValue" in "create rule page"       
 And I click "Special Offers" in "select attribute values window" 
 And I uncheck "Black Friday Specials,Clearance/Closeout,Everyday Value,Free Shipping" in "select attribute values window"
...
Then I should see "popup error" messages 
        |Selecting 'OK' will cancel all your changes and 'Cancel' to come back to previous screen.|
When I click "Cancel" in "popup window"
 And I click "Hair Care" in "select attribute values window" 
 And I check "following attribute values in select attribute values window"
        |Brushes & Combs|
        |Conditioner|
        |Dry Shampoo|
...
Then I should see "effectivedate" as "today" in "rules detailed page"
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "following selected attribute values" from "Hair Care"        
        |Brushes & Combs|
        |Conditioner|
        |Dry Shampoo|

@regression_mcom_pom
@jregression_19508_3_4.8_mcom
...
When I click "addAttributeValue" in "create rule page"
  And I click "Sport" in "select attribute values window" 
  And I check "following attribute values in select attribute values window"
        |Basketball|
        |Bicycling|
        |Hiking|
...
When I click "addAttributeValue" in "create rule page"
 And I click "Speed" in "select attribute values window"
 And I check "following attribute values in select attribute values window"
        |10 Mixing Speeds|
        |12 speed|
 ...
 And I delete the "Sport" with "modify result set attribute values"
 And I save the "action" with "action atrributes"
 And I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "category id"
Then I should see Publish Flag "ON"
...
Then I should see "following selected attribute values" from "Special Offers"        
                ...
                |Clearance/Closeout|
                |Everyday Value|
Then I should see "following selected attribute values" from "Speed"
               |10 Mixing Speeds|
               |12 speed|
               |10-Speed Slide Control|

@regression_mcom_pom
@jregression_19508_4_4.8
...
When I select "Modify Result Set" from "action drop down" in "create rule page"
 ...
 And I should see "addAttributeValue" as "button" in "create rule page"
When I click "addAttributeValue" in "create rule page"
 And I click "Age" in "select attribute values window" 
 And I check "following attribute values in select attribute values window"
        |0-12 months|
        |12-24 months|
        |13 Years and Up|
...
Then I should see "effectivedate" as "today" in "rules detailed page"
Then I should see "expirationdate" as "tomorrow" in "rules detailed page"
Then I should see "following selected attribute values" from "Age"        
                |0-12 months|
                |12-24 months|
                |13 Years and Up|
Then I should see "product id" as "4199" in "rules detailed page"
...
Then I should see "popup error" messages 
        |The sequence number should be a positive number.|
When I click "Ok" in "popup window"
When I enter "sequence value" as "1.1" in "sequence text field"
 And I save the "action" with "action atrributes"
Then I should see "<following errors>" messages
     |Saved set/saved query id entered is incorrect, please change the id to save the action| 
...
Then I should see "following selected attribute values" from "Special Offers"        
                ...
                |Everyday Value|
Then I should see "sequence" as "2" in "create rule page"                
Then I should see "following selected attribute values" from "Sport"        
                  |Basketball|
                  |Bicycling|
                 
@regression_mcom_pom
@jregression_19508_7_4.8
...
When I select "RDPP Algorithm" from "action drop down" in "create rule page"
Then I should see "rdpp algorithm options enabled" in "create rule page"
When I select "65 - SALE/AVAILABILITY" from "rdpp algorithm type drop down" in "create rule page"
 And I enter "effective date" as "current date for rdpp algorithm" in "create rule page"
 And I enter "expiration date" as "future date for rdpp algorithm" in "create rule page"
 And I save the "action" with "action atrribute"
...
When I select "Category Redirect" from "action drop down" in "create rule page"
 And I enter "category id" as "121" in "create rule page"
 And I save the "action" with "action atrribute"
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
Then I should see "following triggers enabled" from "trigger drop down"
 ...
 And I enter "media group id" as "200252" in "create rule page"  
 And I save the "action" with "action atrribute"
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
When I select "Copy Block Media" from "select media type dropdown" in "create rule page"  
 And I enter "media group id" as "565924" in "create rule page"  
 And I save the "action" with "action atrribute" 
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
When I select "Result Set" from "trigger drop down" in "create rule page"                  
 And I create "result set trigger" with "Category" and the value as "51145,>,70"
 And I click "plusicon" in "create rule page"
...
Then I should see "select trigger drop down displayed" in "create rule page"
When I select "Facet Refinement" from "trigger drop down" in "create rule page"                  
 And I create "facet refinement trigger" with "Brand" and the value as "100% Pure,1888 Mills"
 And I click "plusicon" in "create rule page"
 And I create "facet refinement trigger" with "Product Color" and the value as "gold,green"
 And I click "plusicon" in "create rule page"
 And I create "facet refinement trigger" with "Occasion" and the value as "evening,formal"
 And I save the "triggers" with "keyword"  
Then I should see "following actions enabled" from "action drop down"
                  |RDPP Algorithm|
                  |Display Message|
...
When I select "Category Ids" from "trigger drop down" in "create rule page"                  
 And I enter "category ids" as "199" in "create rule page"
 And I save the "triggers" with "keyword"  
Then I should see "following actions enabled" from "action drop down"
                  |RDPP Algorithm|
                  |Show Master or Member Products|
...
Then I should see "rdpp algorithm options enabled" in "create rule page"
When I select "65 - SALE/AVAILABILITY" from "rdpp algorithm type drop down" in "rules detailed page"
...
Then I should see "following triggers enabled" from "trigger drop down"
 ...
 And I enter "media group id" as "200252" in "rules detailed page"  
 And I save the "action" with "action atrribute"
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
When I select "Copy Block Media" from "select media type dropdown" in "rules detailed page"  
 And I enter "media group id" as "565924" in "rules detailed page"  
 And I save the "action" with "action atrribute" 
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
When I select "Show Facets" from "action drop down" in "rules detailed page"
 ...
 And I select "Age,Color Family" from "show facets drop down" in "rules detailed page"
 And I save the "action" with "action atrributes"
Then I should see "following triggers enabled" from "trigger drop down"
                  |Keyword Pattern|
                  |Keyword|
...
When I select "Modify Result Set" from "action drop down" in "rules detailed page"
 ...
 And I enter "saved set query id" as "1873430" in "rules detailed page"
 And I save the "action" with "action atrributes"
...
When I select "Category Ids" from "trigger drop down" in "rules detailed page"                  
 And I enter "category ids" as "199" in "rules detailed page"
 And I save the "triggers" with "keyword"  
Then I should see "following actions enabled" from "action drop down"
                  |RDPP Algorithm|
                  |Show Master or Member Products|
...
@show_media
@regression_mcom_pom
@show_media_action_mcom
Scenario: creating,editing,canceling & error validation for show media action
Given I have logged into Saturn as a Merchandise user
When I click "Create Rule" from "RULES"
...
When I select "Show Media" from "action drop down" in "create rule page"
 And I save the "action" with "action atrribute"
Then I should see "<popup error>" messages 
            |Select one Media Type.|
When I click "Ok" in "popup window"
 And I select "Banners" from "select media type dropdown" in "create rule page"
 And I save the "action" with "action atrribute"
Then I should see "<popup error>" messages 
            |Please enter the Media Group ID to save the action.|
            |Select one Location.|
When I click "Ok" in "popup window"
 And I enter "media group id" as "123456" in "create rule page"
 And I select "KWS_TOP_BANNER" from "media group location" in "create rule page"
 And I save the "action" with "action atrribute" 
Then I should see "<following error>" messages 
            |The Media Group ID entered is not valid, please correct it to save the action|
 And I select "KWS_MIDDLE_BANNER" from "media group location" in "create rule page"
 And I save the "action" with "action atrribute" 
Then I should see "<following error>" messages 
            |The Media Group ID entered is not valid, please correct it to save the action|
 And I select "KWS_BOTTOM_BANNER" from "media group location" in "create rule page"
 And I save the "action" with "action atrribute" 
Then I should see "<following error>" messages 
            |The Media Group ID entered is not valid, please correct it to save the action|                      
When I select "Zero Results Media" from "select media type dropdown" in "create rule page"
 And I save the "action" with "action atrribute"
Then I should see "<popup error>" messages 
            |Please enter at least one numeric media pool id to save the action|
When I click "Ok" in "popup window" 
 And I enter "media group id" as "123456789" in "create rule page"
Then I should see "<following error>" messages 
            |Please enter the valid media pool id to save the action| 
When I select "Copy Block Media" from "select media type dropdown" in "create rule page"
 And I save the "action" with "action atrribute"
Then I should see "<popup error>" messages 
            |Please enter the Media Group ID to save the action.|
When I click "Ok" in "popup window"           
 And I enter "media group id" as "12345678" in "create rule page"  
 And I save the "action" with "action atrribute"                
Then I should see "<following error>" messages 
            |Please enter valid media group id/s to save the action|
When I select "Banners" from "select media type dropdown" in "create rule page"
 And I enter "media group id" as "49490" in "create rule page"
 And I select "KWS_TOP_BANNER" from "media group location" in "create rule page"
 And I save the "action" with "action atrribute"
 And I click "edit action" in "create rule page"
 And I enter "media group id" as "49488" in "create rule page"
 And I select "KWS_MIDDLE_BANNER" from "media group location" in "create rule page"
...
When I select "Copy Block Media" from "select media type dropdown" in "create rule page"  
 ...
 And I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "actions"
Then I should see "show media Banner" in "rule detailed page" 
Then I should see "show media zero results media" in "rule detailed page" 
Then I should see "show media copy block media" in "rule detailed page" 
Then I should see "show media actions" as "Zero Results Media" in "rules detailed page" 
 When I click "Copy button" in "rules detail page"
 When I click "edit action" in "rules detail page"
  And I enter "media group id" as "200595" in "create rule page"
  And I save the "action" with "action atrribute"
  And I save the "rules details page" with "show media action"
Then I should see "rulename" as "Copy of showmedia" in "rules detailed page"
When I click "Edit Rule" in "rules detail page"
Then I should see "show media actions" as "Copy Block Media" in "rules detailed page" 
When I click "edit action" in "rules detail page"
  And I enter "media group id" as "566139" in "create rule page"
  And I save the "action" with "action atrribute"
  And I save the "rules details page" with "show media action"
Then I should see "rulename" as "Copy of showmedia" in "rules detailed page"
 And I should see "description" as "resultsettesting" in "rules detail page"
 ...
 And I should see Publish Flag "ON"
 And I should see "Rule Effective State" as "Effective" in "rules detail page"
 And I should see "selected action type" as "Show Media" in "rules detail page"
 And I should see "show media action presents with select media type actions" in "rules detail page"
 And I should see "Copy Block Media" with "566139,KWS_COPY_BLOCK"
 And I should see "Zero Results Media" with "200595"
 And I should see "Banners" with "49488,KWS_MIDDLE_BANNER"
 
@regression_mcom_pom
@jregression_mcom_qa
@rdpp_action_mcom_11092315
Scenario: rdpp action creation,editing,cancel & error validation
Given I have logged into Saturn as a Merchandise user
When I click "Create Rule" from "RULES"
When I enter "rulename" as "rdppaction" in "saturn main page"
When I enter "description" as "resultsettesting" in "saturn main page"
...
Then I should see "rdpp algorithm options enabled" in "create rule page" 
 And I save the "action" with "action atrribute"
Then I should see "<following errors>" messages 
            |Please select a RDPP Algorithm before saving the action.|
            |Please enter effective date and expiration date to save the action|
When I click "Ok" in "popup window"
When I select "78 - 100DollarSales" from "rdpp algorithm type drop down" in "create rule page"
Then I should see "RDPP Algorithm drop down,effective,expiration,plusicon and cross mark" in "create rule page"
 And I save the "action" with "action atrribute"
...
When I select "78 - 100DollarSales" from "rdpp algorithm type drop down" in "create rule page"
 ...
 And I save the "action" with "action atrribute"
Then I should see "<following errors>" messages 
            |Effective and Expiration Dates for Algorithms within a single action may not overlap.|
When I click "Ok" in "popup window"  
 And I click "cross mark" in "create rule page"
 And I save the "action" with "action atrribute"
 And I click "edit action" in "create rule page"
 And I select "62 - AVAILABILITY/AGE/PRICE" from "rdpp algorithm type drop down" in "create rule page"
 And I save the "action" with "action atrribute"
 And I click "edit action" in "create rule page"
 And I select "84 - Best Sellers" from "rdpp algorithm type drop down" in "create rule page"
 And I click "cancel button to remove the changes from actions" in "create rule page"
 And I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "actions"
 And I click "Copy button" in "rules detail page"
...
Then I should see "RDPP Algorithm drop down,effective,expiration,plusicon and cross mark" in "create rule page"
When I select "72 - CLEARANCE/AVAILABILITY" from "rdpp algorithm type drop down" in "rule detail page" 
 And I save the "action" with "action atrribute"
 When I save the "rules details page" with "rdpp algorithm"
 When I click "Edit Rule" in "rules detailed page"
 And I click "edit action" in "rules detail page"
When I select "75 - 50DollarSales/30Avail/20Age" from "rdpp algorithm type drop down" in "rule detail page" 
 And I save the "action" with "action atrribute"
 And I save the "rules details page" with "rdpp algorithm"
Then I should see "rulename" as "rulestesting" in "rules detailed page"
 And I should see "rdpp algorithm type" as "75 - 50DollarSales/30Avail/20Age" in "rules detailed page"
 And I should see "effective date" as "current date" in "rules detailed page"
 And I should see "expiration date" as "tomorrow date" in "rules detailed page"

@regression_mcom_pom
@category_redirect_action_mcom
...
When I enter "category id" as "121" in "create rule page"
 And I click "select facet button" in "create rule page"
 And I select "Brand" from "facet sub window" in "create rule page"
 And I select "10 Strawberry Street,101 Ocean Parkway" from "facet value sub window" in "create rule page"
 And I click "Ok" in "select facet window"
 And I click "select facet button" in "create rule page"
Then I should see "facet and values" as "Brand&10 Strawberry Street, 101 Ocean Parkway" in "select facet window"
When I select "Special Offers" from "facet sub window" in "create rule page"
 And I select "Black Friday Specials,Clearance/Closeout" from "facet value sub window" in "create rule page"
 And I click "Ok" in "select facet window"
 And I save the "action" with "action atrribute"
 And I click "edit action" in "rules detail page"
 And I click "select facet button" in "create rule page"
 And I select "Brand" from "facet sub window" in "create rule page"
 And I uncheck "10 Strawberry Street" in "select facet window"
 And I click "Cancel" in "select facet window"
Then I should see "facet and values" as "Brand&10 Strawberry Street, 101 Ocean Parkway" in "select facet window"
Then I should see "facet and values" as "Special Offers&Black Friday Specials, Clearance/Closeout" in "select facet window" 
 And I click "cancel button to remove the changes from actions" in "create rule page"
Then I should see "facet and values" as "Brand&10 Strawberry Street, 101 Ocean Parkway" in "select facet window"
Then I should see "facet and values" as "Special Offers&Black Friday Specials, Clearance/Closeout" in "select facet window"
 And I click "edit action" in "rules detail page"
...
When I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "actions"
Then I should see "facet and values" as "Brand&101 Ocean Parkway" in "select facet window"
Then I should see "facet and values" as "Special Offers&Black Friday Specials, Clearance/Closeout" in "select facet window"
When I click "Copy button" in "rules detail page"
 And I click "edit action" in "rules detail page"
 And I click "select facet button" in "create rule page"
 And I select "Brand" from "facet sub window" in "create rule page"
 And I select "10 Strawberry Street" from "facet value sub window" in "create rule page"
 And I click "Ok" in "select facet window"
 And I click "cancel button to remove the changes from actions" in "create rule page"
 And I click "edit action" in "rules detail page"
 And I click "select facet button" in "create rule page"
...
Then I should see "<following errors>" messages 
            |Invalid product id|
When I enter "pdp id" as "4199" in "create rule page"
 And I save the "action" with "action atrribute"
 And I click "edit action" in "create rule page"
 And I enter "pdp id" as "93005" in "create rule page"
 And I click "cancel button to remove the changes from actions" in "create rule page"
 And I click "edit action" in "create rule page"
 And I enter "pdp id" as "93005" in "create rule page"
 And I save the "action" with "action atrribute"
...
Then I should see "rulename" as "pdpredirect" in "rules detailed page"
 And I should see "pdpid" as "93005" in "rules detailed page"
When I click "Copy button" in "rules detail page"
 And I click "edit action" in "rules detail page"
 And I enter "pdp id" as "88524" in "create rule page"
 And I click "cancel button to remove the changes from actions" in "create rule page"
 And I click "edit action" in "create rule page"
 And I enter "pdp id" as "88524" in "create rule page"
 And I save the "action" with "action atrribute"
...
Then I should see "rulename" as "Copy of pdpredirect" in "rules detailed page"
 And I should see "pdpid" as "88524" in "rules detailed page"
When I click "Edit Rule" in "rules detailed page"
 And I click "edit action" in "rules detail page"
 And I enter "pdp id" as "83815" in "create rule page"
 And I save the "action" with "action atrribute"
 And I save the "rules details page" with "pdp redirect actions"
Then I should see "rulename" as "Copy of pdpredirect" in "rules detailed page"
 And I should see "pdpid" as "83815" in "rules detailed page"

@regression_mcom_pom 
@show_master_member_products1
...
When I click "Copy button" in "rules detail page"
 ...
 And I select "Show only the Member Products" from "select display drop down" in "create rule page"
 And I save the "action" with "action atrribute"
 And I save the "rules details page" with "Show only the Member Products action"
...
@regression_mcom_pom
@show_facet_action_mcom_all_option
...
When I select "All" from "show facet filter by drop down" in "create rule page"
 And I click "showfacet find button" in "create rule page"
 And I select "Age,Color Family,Blanket,Accessories Type" from "show facets drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "edit action" in "create rule page"
 And I enter "sequence number" as "1" for "Blanket" in "create rule page"
 And I select "Collection,Handbag Material" from "show facets drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "edit action" in "create rule page"
 And I click "Accessories Type" in "facets window to make it uncheck"
 And I enter "text1" as "display name" for the facet "Collection"
 And I enter "text2" as "display name" for the facet "Blanket"
 And I save the "action" with "action atrributes"    
 And I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "actions"
Then I should see "showfacet actions displayed" in "rule details page"
...
When I click "Copy button" in "rules detail page"
 And I click "edit action" in "rules detail page"
 And I select "Brand,Foam" from "show facets drop down" in "create rule page"
 And I remove "text2" from "display name field" for "Blanket"
 And I save the "action" with "action atrributes"
 And I save the "rules details page" with "show facet action"
Then I should see "showfacet actions displayed" in "rule details page"
Then I should see "following facets with sequence numbers and displayname" from "show facet table" 
...
@regression_mcom_pom             
@show_facet_action_mcom_producttype_option
...
When I select "Show Facets" from "action drop down" in "create rule page"
 And I select "Product Type" from "show facet filter by drop down" in "create rule page"
 And I enter "show facet product type" as "shoes" in "create rule page"
 And I click "show facet product type find button" in "create rule page"
 And I select "Sandal Type,Shoe Style,Shoe Type,Gender" from "show facets drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "edit action" in "create rule page"
 And I enter "sequence number" as "1" for "Shoe Type" in "create rule page"
 And I select "Toe Type,Age Category" from "show facets drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "edit action" in "create rule page"
 And I click "Gender" in "facets window to make it uncheck"
 And I enter "text1" as "display name" for the facet "Sandal Type"
...
Then I should see "showfacet actions displayed" in "rule details page"
Then I should see "following facets with sequence numbers and displayname" from "show facet table" 
             |Shoe Type   |1|Shoe Type |
             |Sandal Type |1|text1     |
             |Shoe Style  |2|Shoe Style|
             |Toe Type    |5|text2     |
             |Age Category|6|Age Group |
When I click "Edit Rule" in "rules detailed page"
 And I click "edit action" in "rules detail page"
 And I click "Shoe Style" in "facets window to make it uncheck"  
 And I save the "action" with "action atrributes"
 And I save the "rules details page" with "show facet action"
Then I should see "showfacet actions displayed" in "rule details page" 
When I click "Copy button" in "rules detail page"
 And I click "edit action" in "rules detail page"
 And I remove "text1" from "display name field" for "Sandal Type"
 And I save the "action" with "action atrributes"
 And I save the "rules details page" with "show facet action"
Then I should see "showfacet actions displayed" in "rule details page"

@regression_mcom_pom
@jregression_19302_4.8_mcom
...
@regression_mcom_pom                  
@jregression_20254_4.10_mcom_12345
...
When I save the "triggergroup" with "trigger group name"
 ...
 And I should see "following actions disabled" from "action drop down"
                  ...
                  |Execute New Search|                 
When I select "Modify Result Set" from "action drop down" in "create rule page"
Then I should see "following mrs operators disabled" from "modify result set operator drop down"
                    |Add|
                    |Remove|
                    |Replace| 
...
@regression_mcom_pom
@jregression_20264_4.10_mcom_vo_B_03155
...
Then I should see "rulename" as "showfacetaction" in "rules detail page"
 And I should see "description" as "resultsettesting" in "rules detail page"
 And I should see "effectivedate" as "today" in "rules detail page"
 And I should see "expirationdate" as "tomorrow" in "rules detail page"
 #And I should see "Rule Owner" as "SuperBAUser" in "rules detail page"
...
@regression_mcom_pom
@jregression_20264_4.10_mcom
Scenario: Edit Add/Remove options for existing migration CatHierarchy_Facets rule
Given I have logged into Saturn as a Merchandise user
When I click "Find Rules" from "RULES"
 And I search "10070_CatHierarchy_Facets" as "Rule Name" with "Browse"
 And I click "ruleid" in "Find rule page"
Then I should see "Rule Detail Edit button" as "enabled" in "rules detail page"
 And I should see "Rule Detail Copy button" as "enabled" in "rules detail page"
 And I should see "category ids trigger selected with category ids" in "rule detail page"   
 And I should see "category ids" as "10070" in "rules detail page"
 And I should see "showfacet action table displayed" in "rule detail page"
 And I should see "Add" as "disabled showacet operator" in "create rulepage"
 And I should see "following showfacet operators" from "show facet operator drop down"  
                    |Add|
                    |Remove|
                    |Replace|
 And I should see "selected navigation type" as "Browse" in "rules detail page"
 And I should see "following context attribute values checked" from "context attribute trigger"
                  ...
                  |app|Site,Associate,Mobile,MEW,SEO Link Module,Search & Send,MSA|
                  |inventory|Store,Site,Jewelry,Registry,Shoes,Search & Send|
 And I should see "selected action type" as "Show Facets" in "rules detail page"
 And I should see "rulename" as "10070_CatHierarchy_Facets" in "rules detail page"
 And I click "Edit Rule" in "rules detail page"
 And I click "edit action" in "rules detail page"
 And I select "Replace" from "show facet operators drop down" in "create rule page"
 And I save the "action" with "action atrributes"
 And I save the "rules details page" with "show facet action"
Then I should see "Replace" as "selected show facet operator" in "rules detailed page"
Then I should see "Rule Detail Edit button" as "enabled" in "rules detail page"
...
When I click "cancel button to remove the changes from actions" in "create rule page"
 ...
 And I click "Add Filter" in "create rule page"
 And I select "Bed Size" from "facet autosuggestion drop down" in "select facet window"
 And I select "California King,Queen Split,Queen,Full/Queen,Twin XL" from "facet value frame" in "select facet window"
 And I click "ok in select attribute value window" in "create rule page"
 And I click "Add Filter" in "create rule page"
Then I should see "following facets and facet values in select filter window" from "facets filter window"
         |Bed Size|California King, Queen Split, Queen, Full/Queen, Twin XL|
When I select "Capacity" from "facet autosuggestion drop down" in "select facet window"
 And I select "1.5 quart,10 quarts,11 quarts,12 quarts,2 quarts" from "facet value frame" in "select facet window"
 And I click "ok in select attribute value window" in "create rule page"
 And I save the "action" with "action atrributes"
 And I click "edit action" in "create rule page"
 And I click "facets value cross mark" in "10 quarts"
...
Then I should see "following facets and facet values" from "facets summary panel"
           |Bed Size|Queen Split, Queen, Full/Queen, Twin XL|
           |Capacity|1.5 quart, 11 quarts, 12 quarts, 2 quarts| 
When I click "Edit Rule" in "rules detailed page"
 ...
 And I click "Add Filter" in "create rule page"
 And I select "Coverage" from "facet autosuggestion drop down" in "select facet window"
 And I select "Full,Heavy,Medium,Sheer" from "facet value frame" in "select facet window"
 And I click "ok in select attribute value window" in "create rule page"
 And I save the "action" with "action atrributes"
...
Then I should see "following facets and facet values" from "facets summary panel"
           |Bed Size|Queen Split, Queen, Full/Queen, Twin XL|
           |Capacity|1.5 quart, 11 quarts, 12 quarts, 2 quarts|  
           |Coverage|Full, Heavy, Medium, Sheer| 
...
When I select "Result Set" trigger with "Brand,calvin klein,  >" as "attribute type,attribute value and logicalop respectively"
When I click "plus" in "create trigger group page"
When I select "Result Set" trigger with "Category,51145,  >" as "attribute type,attribute value and logicalop respectively"
When I click "plus" in "create trigger group page"
...
When I select "Facet Refinement" trigger with "Brand,100% Pure" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Facet Refinement" trigger with "Product Color,gold" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Facet Refinement" trigger with "Occasion,evening" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Facet Refinement" trigger with "Material,Leather" as "attribute type and attribute value respectively"
Then I should see "attributes and attribute values has been selected" in "create trigger group"
When I save the "trigger" with "Facet Refinement trigger"
When I click "add trigger" in "create trigger group page"
Then I should see "trigger criteria displayed" in "Product Data Match"
When I select "Product Data Match" trigger with "Search_Type,aftershave" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Search_Occasion,Wedding/Anniversary" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Search_Material,wood" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Search_Gender,Adult" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Search_Style,Relaxed" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Product Noun,garment-bags" as "attribute type and attribute value respectively"
When I click "plus" in "create trigger group page"
When I select "Product Data Match" trigger with "Product Type,Personal Care" as "attribute type and attribute value respectively"
Then I should see "attributes and attribute values has been selected" in "create trigger group"
...
When I select "Category Ids" trigger with "199" as "categoty id"
Then I should see "attributes and attribute values has been selected" in "create trigger group"
...
When I click "Ok" in "popup window"              
 ...
 And I select "1888 Mills" from "facet value suggestion dropdown" in "autosuggestion page"
 And I click "Ok" in "Select Facet Window in AutoSuggestion page"
 And I click "Display Pattern Add Facet button" in "autosuggestion page"
 And I select "Brand,Cookware Collection,Gift Type" from "select facets and Text window" in "autosuggestion page"
...
When I select "Primary_Form_Normal" from "Select Synatx" in "Brand"  
 And I select "Primary_Form_Noun_Mod" from "Select Synatx" in "Cookware Collection" 
...
Then I should see "autosuggestion publish checkbox" as "checked" in "autosuggestion page"
 ...
 And I should see "Apply rule facet and facet value" as "Brand,1888 Mills" in "autosuggestion page"
 And I should see "Display Pattern facet and facet syntax" as "Brand,Primary_Form_Normal" in "autosuggestion page"
 And I should see "Display Pattern facet and facet syntax" as "Cookware Collection,Primary_Form_Noun_Mod" in "autosuggestion page"
...
Then I should see "Brand,1888 Mills" in "select facet summary panel"
 And I select "Boot Type" from "facet suggestion dropdown" in "autosuggestion page"
 And I select "Winter" from "facet value suggestion dropdown" in "autosuggestion page"
 And I click "Cancel" in "Select Facet Window in AutoSuggestion page"  
When I click "apply rule facet edit button" in "autosuggestion page"
Then I should see "Brand,1888 Mills" in "select facet summary panel"
 And I select "Body Care" from "facet suggestion dropdown" in "autosuggestion page"
 And I select "Body Oil" from "facet value suggestion dropdown" in "autosuggestion page"
 And I click "Ok" in "Select Facet Window in AutoSuggestion page" 
 And I click "Display Pattern Add Facet button" in "autosuggestion page"
...
When I select "for" from "display pattern text dropdown" in "autosuggestion page"
 And I click "Cookware Collection" in "display pattern facet cross mark"
...
Then I should see "autosuggestion publish checkbox" as "checked" in "autosuggestion page"
 ...
 And I should see "Apply rule facet and facet value" as "Body Care,Body Oil" in "autosuggestion page"
 And I should see "Display Pattern facet and facet syntax" as "Gift Type,Primary_Form_Noun_Possessive" in "autosuggestion page" 
...
@regression_mcom_pom          
@iteration_4.11          
@jregression_21797_4.11_1_mcom
Scenario: trigger compatibility in creating a trigger group page
Given I have logged into Saturn as a Merchandise user
When I click "Create Trigger Group" from "RULES"
Then I should see "Create Trigger Group page" displayed
...
Then I should see "attributes and attribute values has been selected" in "create trigger group"
When I save the "trigger" with "Category Ids trigger"
When I click "And" in "trigger global operator"
When I save the "create trigger group page" with "triggers"
Then I should see "following error" messages
    |The AND relationship is incompatible with at least one trigger combination. Please check trigger compatibility and update|
    #|At least one trigger is incompatible with another trigger. Please check trigger compatibility and update|
...
Then I should see "trigger group displayed" in "trigger group detail page"
When I click "Create Rule" from "RULES"
When I enter "rulename" as "testing_21798" in "saturn main page"
When I enter "description" as "resultsettesting" in "saturn main page"
When I enter "effectivedate" as "today" in "saturn main page"
When I enter "expirationdate" as "tomorrow date" in "saturn main page"
When I click "add trigger" in "create rule page"
...
@regression_mcom_pom
@iteration_4.11
@jregression_21798_2_4.11_mcom
Scenario: checking triggers compatibility with keyword pattern & categoryid with or operator
Given I have logged into Saturn as a Merchandise user
When I click "Create Trigger Group" from "RULES"
Then I should see "Create Trigger Group page" displayed
When I enter "TriggerGroupName" as "kwp_categoryid_or" in "create trigger group page"
When I enter "description" as "tgcompatibility21798" in "create trigger group page"
When I click "add trigger" in "create rule page"
When I select "Keyword Pattern" trigger with "Brand,ck" as "attribute type and attribute value respectively"
When I save the "trigger" with "keyword pattern trigger"
...
Then I should see "trigger group radio button" as "unchecked" in "create rule page"
When I click "trigger group radio button" in "create rule page"
When I enter "trigger group name" as "kwp_categoryid_or" in "create trigger group page"
When I save the "trigger group" with "trigger group name"
When I click "add trigger" in "create rule page"
 And I click "Or" in "trigger global operator" 
Then I should see "triggers enabled" in "create rule page"
...
When I save the "trigger" with "Category Ids trigger"
When I click "Browse" in "navigation type context attributes"
When I save the "creating rule page" with "triggers & trigger group"
Then I should see "rulename" as "kwp_categoryid_or" in "rules detail page"
 And I should see "description" as "resultsettesting" in "rules detail page"
 And I should see "effectivedate" as "today" in "rules detail page"
 And I should see "expirationdate" as "tomorrow" in "rules detail page"
 #And I should see "Rule Owner" as "SuperBAUser" in "rules detail page"
 ...
 And I should see "Rule Detail Copy button" as "enabled" in "rules detail page"
 And I should see "Rule Effective State" as "Effective" in "rules detail page"  
 And I should see "trigger operator" as "OR" in "trigger group detailed page"    
    
@regression_mcom_pom
@iteration_4.11
@jregression_21798_3_4.11_mcom
Scenario: checking triggers compatibility with categoryid & categoryid with or operator
Given I have logged into Saturn as a Merchandise user
When I click "Create Trigger Group" from "RULES"
Then I should see "Create Trigger Group page" displayed
When I enter "TriggerGroupName" as "categoryid_categoryid_or" in "create trigger group page"
When I enter "description" as "tgcompatibility21798" in "create trigger group page"
When I click "add trigger" in "create rule page"
When I select "Category Ids" trigger with "199" as "categoty id"
When I save the "trigger" with "Category Ids trigger"
...
Then I should see "following error" messages
    |Invalid Canvas ID or Canvas Name; please enter a valid Canvas ID or Canvas Name.|      
When I enter "canvas id or name" as "400489" in "create rule page"
 And I save the "action" with "action atrribute"
When I click "Search" in "navigation type context attributes"
...
Then I should see "Select Media Type" as "Canvas" in "rule detail page"
 And I should see "Canvas ID or Name" as "400489 - Fodsfsb_Esdfsdfvent_Date" in "rule detail page"
 
@regression_mcom_pom 
@iteration_4.11 
@jregression_18636_4.11_mcom
...
Then I should see "Canvas media type" as "disabled" in "create rule page"
When I select "Zero Results Media" from "select media type dropdown" in "create rule page"
 And I enter "media group id" as "200672" in "create rule page"  
 And I save the "action" with "action atrribute"  
 And I click "Search" in "navigation type context attributes"
 And I save the "creating rule page" with "actions"
Then I should see "show media zero results media" in "rule detailed page" 
 And I should see "media group id" as "200252" in "rule detailed page"
 And I should see "media group id" as "200672" in "rule detailed page"
...
When I click "Edit Rule" in "rules detailed page"
 ...
 And I enter "media group id" as "200600" in "rules detail page"  
 And I save the "action" with "action atrribute" 
When I click "add action" in "create rule page"
...
Then I should see "rulename" as "showmedia" in "rules detail page"
 And I should see "description" as "resultsettesting" in "rules detail page"
 And I should see "effectivedate" as "today" in "rules detail page"
 And I should see "expirationdate" as "tomorrow" in "rules detail page"
 #And I should see "Rule Owner" as "SuperBAUser" in "rules detail page"
 ...
 And I should see Publish Flag "ON"
 And I should see "Rule Effective State" as "Effective" in "rules detail page"
 And I should see "show media zero results media" in "rule detail page" 
 And I should see "media group id" as "200252" in "rule detail page"
 And I should see "media group id" as "200672" in "rule detail page"
 And I should see "media group id" as "200600" in "rule detail page"

@regression_mcom_pom
@iteration_4.11
@jregression_18678_19212_4.11_mcom
...
When I append "canvas id" with "048" in the "canvas id or name field"
...
@regression_mcom_pom
@iteration_4.11
@jregression_18678_19212_2_4.11_mcom
Scenario: Autosuggest Canvas Name or ID with invalid 
Given I have logged into Saturn as a Merchandise user
When I click "Create Rule" from "RULES"
When I enter "rulename" as "showmedia" in "saturn main page"
When I enter "description" as "resultsettesting" in "saturn main page"
...
When I select "Show Media" from "action drop down" in "create rule page"
 And I select "Canvas" from "select media type dropdown" in "create rule page"
 And I enter "canvas id" as "0" in "create rule page"
Then I should see "No Autosuggestion drop down" in "canvas id or name field"
When I append "canvas id" with "00" in the "canvas id or name field"
Then I should see "No Autosuggestion drop down" in "canvas id or name field"
When I enter "canvas name" as "abc" in "create rule page"
Then I should see "No Autosuggestion drop down" in "canvas id or name field"
When I append "canvas id" with "df" in the "canvas id or name field"
Then I should see "No Autosuggestion drop down" in "canvas id or name field" 

@regression_mcom_pom
@iteration_4.11
@jregression_21943_4.11_mcom
Scenario: Enable editing for migrated MSR rules
Given I have logged into Saturn as a Merchandise user
When I click "Find Rules" from "RULES"
 And I search "10088_CatHierarchy_ModifiedResults" as "Rule Name" with "Browse"
 And I click "ruleid" in "Find rule page"
Then I should see "Rule Detail Edit button" as "enabled" in "rules detail page"
 And I should see "Rule Detail Copy button" as "enabled" in "rules detail page"
 And I should see "category ids trigger selected with category ids" in "rule detail page"   
 And I should see "category ids" as "10088" in "rules detail page"
 And I should see "Include all children and grandchildren etc" as "unchecked by default" in "rule detail page"
 ...
 And I should see "rulename" as "10088_CatHierarchy_ModifiedResults" in "rules detail page"

@regression_mcom_pom
@jregression_22224_4.11_mcom
...
@regression_mcom_pom 
@jregression_22924_4.12_mcom_vo_B_02652_22923_4.12_mcom_vo_B_2650
...
When I select "80 - Clearance/OH Dollar" from "rdpp algorithm type drop down" in "create rule page"
 ...
 And I enter "tommorow's date" as "rdpp algorithm expiration date" in "create rule page"
 And I click "plusicon in rdpp algorithm" in "create rule page"
 And I select "66 - SOLDU50_SALE30_NEW20" from "rdpp algorithm type drop down" in "create rule page"
 And I enter "today's date" as "rdpp algorithm effective date" in "create rule page"
 And I enter "tommorow's date" as "rdpp algorithm expiration date" in "create rule page"
 And I click "plusicon in rdpp algorithm" in "create rule page"
...
Then I should see "RDPP Algorithm drop down,effective,expiration,plusicon and cross mark" in "create rule page"
 ...
 And I should see "rdpp effective date" as "today date" in "rules detail page"
 And I should see "rdpp expiration date" as "tommorow date" in "rules detail page"
 And I should see "rdpp algorithm type" as "66 - SOLDU50_SALE30_NEW20" in "rules detail page"
 And I should see "rdpp effective date" as "today date" in "rules detail page"
 And I should see "rdpp expiration date" as "tommorow date" in "rules detail page"
 And I should see "rdpp algorithm type" as "80 - Clearance/OH Dollar" in "rules detail page"
 And I should see "rdpp effective date" as "today date" in "rules detail page"
